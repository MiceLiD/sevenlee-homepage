export default function(d3, items, initData, cb) {
  "use strict";
  ...
  var GraphCreator = function(svg, nodes, edges) {
    ...
    d3.select('#container').on("keydown", function() {
    ...
    var dragSvg = d3.behavior.zoom()
      ...
      .on("zoomstart", function() {
        ...
        if (!d3.event.sourceEvent.shiftKey) d3.select('#container').style("cursor", "move");
      })
      .on("zoomend", function() {
    ...
    // handle delete graph
    d3.select("#delete-graph-all").on("click", () => {
      thisGraph.deleteGraph(false);
    })

    // handle delete node
    d3.select("#delete-graph-one").on("click", () => {
      var thisGraph = this,
  ...
  GraphCreator.prototype.insertTitleLinebreaks = function(gEl, title, d) {
    ...
    // d3.json("./scripts/processes.json", function(error, json){
      ...
      var sel = inspector.append("select")
          .on("change", function(d){
            ...
            nodeData.eventId = selectedOption.id;
  ...
  GraphCreator.prototype.updateGraph = function() {
    ...
    newGs.each(function(d) {
      thisGraph.insertTitleLinebreaks(d3.select(this), d.title, d);
    });
  ...
  GraphCreator.prototype.updateWindow = function(svg) {
    var docEl = document.documentElement,
      bodyEl = document.getElementById('container');
    var x = bodyEl.offsetWidth;
    var y = bodyEl.offsetHeight;
  ...
  var nodes = initData.nodes
  var edges = initData.edges
